...
PARAM  <- list()
PARAM$experimento <- "TS9310_final3"

PARAM$exp_input  <- "FE9250_final3"
...
PARAM$train$undersampling  <- 0.90   # 1.0 significa NO undersampling ,  0.1  es quedarse con el 10% de los CONTINUA
