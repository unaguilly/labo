...
PARAM$trainingstrategy$semilla_azar   <- 425783  #Aqui poner la propia semilla
...
PARAM$hyperparametertuning$semilla_azar  <- 315697  #Aqui poner la propia semilla, PUEDE ser distinta a la de trainingstrategy
