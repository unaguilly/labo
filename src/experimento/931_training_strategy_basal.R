...
PARAM  <- list()
PARAM$experimento <- "TS9310_basal"

PARAM$exp_input  <- "FE9250_basal"

PARAM$future       <- c( 202105 )

PARAM$final_train  <- c( 202101, 202102, 202103 )

PARAM$train$training     <- c( 202011, 202012, 202101 )
