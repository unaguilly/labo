...
PARAM  <- list()
PARAM$experimento <- "TS9320_gabriel"

PARAM$exp_input  <- "FE9250_gabriel"

PARAM$future       <- c( 202109 )

PARAM$final_train  <- c( 201905,201906,201907,201908,201909,201910, 201911,201912,
...
PARAM$train$semilla_sampling  <- 609277
PARAM$train$semilla_under     <- 425783
